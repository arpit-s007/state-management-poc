...
class AppStyle {
  AppStyle({Size? screenSize, Orientation? orientation}) {
    ...
    if(isSmall) {
      orientations.addAll([DeviceOrientation.portraitUp,
...
class _Text {
  ...
  late final TextStyle h2 = _createFont(titleFont, sizePx: 48, heightPx: 46);
  late final TextStyle h3 = _createFont(titleFont, sizePx: 32, heightPx: 36, weight: FontWeight.w600);
  late final TextStyle h4 = _createFont(contentFont, sizePx: 24, heightPx: 23);
  late final TextStyle h4_5 = _createFont(contentFont, sizePx: 21, heightPx: 23);
  late final TextStyle h5 = _createFont(contentFont, sizePx: 19, heightPx: 23, weight: FontWeight.w600);

  late final TextStyle title1 = _createFont(titleFont, sizePx: 16, heightPx: 26);
  ...
  late final TextStyle bodyExtraSmall = _createFont(contentFont, sizePx: 12, heightPx: 20);
  late final TextStyle bodyExtraSmallBold = _createFont(contentFont, sizePx: 12, heightPx: 20, weight: FontWeight.w600);
